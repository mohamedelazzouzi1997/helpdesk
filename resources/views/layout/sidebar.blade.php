...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <div class="image"><a href="{{ route('profile') }}"><img src="{{ Auth::user()->image == null ? 'https://ui-avatars.com/api/?color=ff0000&name='.Auth::user()->name : asset('upload/profile/'.Auth::user()->image) }}" alt="{{Auth::user()->name}}"></a></div>
                    <div class="detail">
            ...
            <li class="{{ Request::segment(1) === 'project' ? 'active open' : null }}">
                <a href="#" class="menu-toggle"><i class="zmdi zmdi-assignment"></i> <span>Ticket List</span></a>
                <ul class="ml-menu">
