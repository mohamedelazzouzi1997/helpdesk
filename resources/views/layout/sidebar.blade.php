...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="{{ Request::segment(1) === 'create-project' ? 'active open' : null }}"><a href="{{ route('create.ticket') }}"><i class="fa fa-plus"></i><span>Create Project<span class="badge badge-pill badge-success">New</span></span></a></li>
        </ul>
    </div>
</aside>
